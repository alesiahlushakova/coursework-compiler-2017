...
#define TI_INT_DEFAULT	0x00000000	// значение по умолчанию дл€ типа number
...
#define TI_RC_DEFAULT	false	

namespace IT			// таблица идентификаторов
{
	enum IDDATATYPE { INT = 1, STR = 2, RC = 3 };			// типы данных идентификаторов: integer, string
	enum IDTYPE { V = 1, F = 2, P = 3, L = 4, OP = 5, STD = 6};	// типы идентификаторов: переменна€, функци€, параметр, литерал, оператор
